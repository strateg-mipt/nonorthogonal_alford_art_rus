...
\hline \textbf{}\modelnum{\label{mnum: 3}}& Эллиптическая & $20.00 \times 10.00$ & Austin Chalk & 60 & 45 \\
\hline 
\end{tabularx}
...
\hline	\textbf{Модель \ref{mnum: 10}} & \textbf{8.3898} & \textbf{8.1241} & \textbf{-81.6102}  & \textbf{-81.5622} & \textbf{0.3}  & \textbf{0.0169} & \textbf{0.0169} \\
		...
		Модель \ref{mnum: 10} с НЧФ \ref{lffnum: 6} & 50.9972 & 48.9931 & -39.0028 & -37.8245  & 3.18 & 0.0668 & 0.0658\\
...
\hline	\textbf{Модель \ref{mnum: 3}} & \textbf{-10.5111} & \textbf{-26.3606} & \textbf{79.4889}  & \textbf{-80.4622}  & \textbf{16.82}  & \textbf{0.1726} & \textbf{0.1511} \\
		Модель \ref{mnum: 3} с НЧФ \ref{lffnum: 1} & -30.6596 & -41.5868 & 59.3404 & 68.1357  & 19.7225  & 0.0358 & 0.0027 \\
		Модель \ref{mnum: 3} с ВЧФ \ref{hffnum: 1} & -1.7554 & -4.9971 & 88.2446 & 88.5870  & 3.5841 & 0.0602 & 0.0597 \\	
\hline	
...
\begin{figure}[h]
	...
	\begin{minipage}{0.98\linewidth}
		...
		\psfragfig[width=0.80\linewidth,crop=pdfcrop]{./images/filtering/BS_HTI_45/graph_bp_filter_study_500} \\
	\end{minipage}
