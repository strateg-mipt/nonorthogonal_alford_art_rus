...
\hline Модель \ref{mnum: 11} & 15.56 & 14.72 & -74.44 & -73.92  & 1.36  & 0.0299 & 0.0298 \\
\hline Модель \ref{mnum: 10} & 8.39 & 8.12 & -81.61 & -81.56 & 0.32 & 0.0169 & 0.0168 \\
\hline Модель \ref{mnum: 12} & 3.26 & 3.04 & -86.74 & -86.66  & 0.30 & 0.0075 & 0.0075 \\ 
\hline Модель \ref{mnum: 9} & 1.63 & 1.78 & -88.37 & -88.42  & 0.00  & 0.0064 & 0.0064 \\	   
 	   \hline
\end{tabularx} 
\begin{flushleft}
...
\hline	\textbf{Модель \ref{mnum: 11}} & \textbf{15.56} & \textbf{14.72} & \textbf{-74.44}  & \textbf{-73.92}  & \textbf{1.36}  & \textbf{0.0299} & \textbf{0.0297} \\
		Модель \ref{mnum: 11} с НЧФ \ref{lffnum: 3} & 49.41 & 40.46 & -40.59 & -35.41  & 14.13 & 0.0204 & 0.0124\\
		Модель \ref{mnum: 11} с ВЧФ \ref{hffnum: 1} & 14.01 & 13.25 & -75.99 & -75.58  & 1.17 & 0.0039 & 0.0038\\
\hline	\textbf{Модель \ref{mnum: 10}} & \textbf{8.39} & \textbf{8.12} & \textbf{-81.61}  & \textbf{-81.56} & \textbf{0.32}  & \textbf{0.0169} & \textbf{0.0169} \\
		Модель \ref{mnum: 10} с НЧФ \ref{lffnum: 3} & 41.21 & 25.71 & -48.79 & -31.97  & 32.32 & 0.2210 & 0.1199\\
		Модель \ref{mnum: 10} с ВЧФ \ref{hffnum: 2} & 7.54 & 10.22 & -82.46 & -82.63  & 2.84 & 0.0110 & 0.0101\\
\hline	\textbf{Модель \ref{mnum: 12}} & \textbf{3.26} & \textbf{3.04} & \textbf{-86.74}  & \textbf{-86.66}  & \textbf{0.30}  & \textbf{0.0075} & \textbf{0.0075}\\
		Модель \ref{mnum: 12} с НЧФ \ref{lffnum: 4} & 48.42 & 39.73 & -41.58 & -35.50  & 14.77  & 0.0974 & 0.0701 \\
		Модель \ref{mnum: 12} с ВЧФ \ref{hffnum: 3} & 2.77 & 3.26 & -87.23 & -87.43  & 0.69  & 0.0045 & 0.0045\\	
\hline	\textbf{Модель \ref{mnum: 9}} & \textbf{1.63} & \textbf{1.78} & \textbf{-88.37}  & \textbf{-88.42}  & \textbf{0.00}  & \textbf{0.0064} & \textbf{0.0064} \\
		Модель \ref{mnum: 9} с НЧФ \ref{lffnum: 4} & 6.03 & 7.73 & -83.97 & -56.60  & 25.67  & 0.0789 & 0.0726 \\
...
\begin{figure}[h]
\centering
\begin{tabular*}{\textwidth}{c|rr|rr|}
\hline
...
\renewcommand{\arraystretch}{1.0}
\normalsize
\caption{Результаты расчетов собственных векторов для Модели \ref{mnum: 11} и Модели \ref{mnum: 10}}
